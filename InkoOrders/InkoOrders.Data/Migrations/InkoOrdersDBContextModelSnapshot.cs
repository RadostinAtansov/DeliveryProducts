...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InkoOrders.Data.Model.Storage.HistoryWrittenOffStock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("DateTimeWriteOff")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("ReasonToWriteOff")
                        .IsRequired()
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");
                    ...
                    b.ToTable("HistoryWrittenOffStocks");
                });
            ...
            modelBuilder.Entity("InkoOrders.Data.Model.Storage.InvoicesStorageMaterial", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InkoOrders.Data.Model.Storage.StockToWriteOff", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InkoOrders.Data.Model.Storage.InvoicesStorageMaterial", b =>
                {
                    b.HasOne("InkoOrders.Data.Model.Storage.MaterialsInInko", "Material")
                        .WithMany("InvoicesMaterial")
